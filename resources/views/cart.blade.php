                ...
                <div class="flex-1">
                    <table class="w-full text-sm lg:text-base" cellspacing="0">
                        <thead>
                            <tr class="h-12 uppercase">
                                ...
                                <th class="hidden text-right md:table-cell">Editar</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-left md:text-center">
                                    <a href="#" class="md:ml-4">{{ $item->name }}</a>
                                </td>
                                <td class="text-center md:text-right">
                                    <div class="h-10 w-28">
                                        <div class="relative flex flex-row w-full h-8">
                                            <form action="{{ route('cart.update') }}" method="POST">
                                                ...
                                                <button type="submit" class="px-2 pb-2 ml-2 text-white bg-blue-500">
                                ...
                                <td class="text-right md:text-center">
                                    <form action="{{ route('cart.remove') }}" method="POST">
                                        ...
                                        <button class="px-4 py-2 text-white bg-red-600">Eliminar</button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach
                    ...
                    <div class="mt-4">
                        <form action="{{ route('cart.clear') }}" method="POST">
                            @csrf
                            <button class="px-6 py-2 text-red-800 bg-red-300">Eliminar todo el carrito</button>
                        </form>
                    </div>
                    <div class="mt-4">
                        <a href="{{ route('cart.redirectToOrderForm') }}" class="inline-block px-6 py-3 text-white bg-green-500 hover:bg-green-600 rounded-md">

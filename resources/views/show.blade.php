...
@section('content')
            ...
            <div class="p-4 border-b">
                ...
                <ul>
                    ...
                    <li class="flex items-center border-b py-2">
                        <img src="{{ asset('images/' . $orderProduct->product->image) }}" alt="{{ $orderProduct->product->name }}" class="w-16 h-16 object-cover rounded">
                        <div class="ml-4">
    ...
    <center>
        <a href="{{ route('paypal.payment') }}" class="inline-block px-6 py-3 text-white bg-green-500 hover:bg-green-600 rounded-md">Pagar con PayPal </a>
    </center>
    @yield('footer')
@endsection

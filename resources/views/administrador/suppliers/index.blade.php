    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <a href="{{ route('suppliers.create') }}" class="bg-green-500 text-white p-2 rounded-md mb-4">Crear Proveedor</a>
                            ...
                            <tbody class="divide-y divide-gray-700">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($supplier->image)
                                            <img src="{{ asset('images/' . $supplier->image) }}" alt="{{ $supplier->name }}" class="h-16 w-16 rounded-full object-cover">
                                        @else
                                            Sin imagen
                                        @endif
                                    </td>
